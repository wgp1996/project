package com.ruoyi.common.utils.JpushClientUtil;
...
public class JpushClientUtil {
    private final static String appKey = "cbe86e60486b8162fc0f2be7";

    private final static String masterSecret = "78272a10571d6a74ac0107f4";
    ...
    private static PushPayload buildPushObject_all_registrationId_alertWithTitle(String registrationId,String notification_title, String msg_title, String msg_content, String extrasparam) {
        ...
        return PushPayload.newBuilder()
                ...
                //指定推送的接收对象，all代表所有人，也可以指定已经设置成功的tag或alias或该应应用客户端调用接口获取到的registration id  Audience.registrationId(registrationId)
